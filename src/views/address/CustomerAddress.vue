      ...
      <div class="address-form">
        ...
        <form class="" @submit.prevent="createBusinessAddress()">
          ...
          <ion-item>
            ...
            <ion-select aria-required="required" id="one" @ionChange="business_address.city = $event.target.value">
...
async function createBusinessAddress() {
  if (business_address.state === null) {
    ...
    await TokenService.updateCusAddress({
      state: {
        state_id: business_address.state.state_id,
        name: business_address.state.name,
      },
      city: {
        city_id: business_address.city.city_id,
        name: business_address.city.name,
      },
    });
...
onMounted(async () => {
  ...
  if (localStorage.getItem('business_address_state') && localStorage.getItem('business_address_city')) {
    ...
    console.log((localStorage.getItem('business_address_state') ))
});
</script>
