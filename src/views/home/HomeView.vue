  ...
  <ion-page>
            ...
            <ion-row class="ion-justify-content-between">
              <ion-col>
                <ion-item>
                  ...
                  <ion-select placeholder="Category" :multiple="true" @ionChange="getCatValues($event)">
                    <ion-select-option v-for="cat in categories" :key="cat.id" :value="cat.id">{{ cat.name }}
                    </ion-select-option>
                  </ion-select>
                </ion-item>
              </ion-col>
    ...
    <ion-content>
      <div class="container" v-if="offerData">
        ...
        <!-- card listing -->
        <div class="card-listing" v-for="offer in offerData" :key="offer.id" @click="
          openModal(
            offer.id,
